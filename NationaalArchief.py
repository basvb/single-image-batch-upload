...
def main():
    #main function: the search-string and categories have to be manually set for each upload then the file can be run as a whole.
    ...
    for i in range(0,nrOfHundredFiles+1):
        sendurl='http://www.gahetna.nl/beeldbank-api/opensearch/?q='+ searchstring +'&count=100&startIndex='+ str(i) +'01'
        print(sendurl)
